...
-- Spawn some usefull applications (DO NOT do it this way,
-- it spawns them on restart)
--awful.spawn.with_shell("emacs&")
--awful.spawn.with_shell("chromium-browser&")

-- Load a wallpaper the quick and dirty way
beautiful.wallpaper = awful.util.get_configuration_dir() .. "images/road-and-sky.jpg"
for s = 1, screen.count() do
   gears.wallpaper.maximized(beautiful.wallpaper, s, true)
end

-- Cycle focus settings
